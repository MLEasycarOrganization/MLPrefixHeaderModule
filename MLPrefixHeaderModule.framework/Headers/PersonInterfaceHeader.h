...
#define PERSON_GetMessage_ByWXCode_URL_V2 @"zkmlperson/mobileTerminal/wxLoginV2"
// 新版个人登录的URL
#define PERSON_LOGIN_URL_V2 @"zkmlperson/mobileTerminal/loginV2"
// 新版切换单位，根据单位获取人员信息
#define PERSON_ChangeOrgan_URL_V2 @"zkmlperson/mobileTerminal/userChangeOrganV2"
// 新版设置默认登录单位
#define PERSON_ChangeDefaultOrgan_URL_V2 @"zkmlperson/mobileTerminal/updateDefaultLoginPlatformV2"

// 个人登录的URL
#define PERSON_LOGIN_URL @"zkmlperson/mobileTerminal/login" //+
// 个人平台加入单位根据部署标识获取IP地址
#define PERSON_GET_IPAndPortByDeploySign_URL @"zkmlperson/mobileTerminal/getIPAndPortByDeploySign"
...
#define PERSON_GET_BANNER_URL @"zkmlperson/mobileResource/v2/reqAdvertisementURL" //+
...
//个人平台-删除父类一级消息【New】
#define Person_Delegate_DelMessageCategoryByParentIdV1_URL           @"zkmlperson/mobileTerminal/delMessageCategoryByParentIdV1"
//个人平台-删除运营平台更新消息【New】
#define Person_Delegate_DeleteAppVersionMsgByAppMsgId_URL           @"zkmlperson/mobileTerminal/deleteAppVersionMsgByAppMsgId"
...
//个人平台-获取租赁公司客服电话【New】
#define Person_Get_ServicePhone_Message_URL           @"zkmlperson/mobileTerminal/v2/reqServicePhone"
//个人平台-个人订单的提醒审核【New】
...
#define Person_GetApplyIdAndCheckByApplySn_URL   @"zkmlperson/mvc/app/apply/getApplyIdAndCheckByApplySn"
...
//个人平台-自驾获取订单数量
#define Person_Get_SelfDriveOrderCount_URL   @"appGateway/self_driver/order/findOrderCount"
//个人平台-自驾获取车辆列表数量
#define Person_Get_FindSelfDriveCarList_URL   @"appGateway/self_driver/car/findSelfDriveCarList"
//个人平台-自驾创建订单
#define Person_CreatIinsertSelfDriveOrder_URL   @"appGateway/self_driver/order/insertOrderBaseV2"
//个人平台-获取自驾费用标准
#define Person_GetSelfDriveTwoBillStandard_URL  @"appGateway/self_driver/car/findTwoBillStandard"
//个人平台-获取自驾服务单位列表
#define Person_GetSelfDriveBranchList_URL  @"appGateway/self_driver/car/findSelfDriveBranchList"
//个人平台-获取自驾订单列表
#define Person_GetSelfDriveOrderList_URL  @"appGateway/self_driver/order/orderList"
//个人平台-获取自驾支付宝支付配置
#define Person_GetSelfDriveAliOrderPay_URL @"appGateway/self_driver/order/toAliOrderPay"
//个人平台-获取自驾微信支付配置
#define Person_GetSelfDriveWeiXinOrderPay_URL @"appGateway/self_driver/order/toWeiXinOrderPay"
//个人平台-获取自驾取消订单
#define Person_GetSelfDriveCancelOrder_URL @"appGateway/self_driver/order/cancelOrderByOrderId"
//个人平台-获取自驾订单详情
#define Person_GetSelfDriveOrderDetail_URL @"appGateway/self_driver/order/findOrderByOrderId"
//个人平台-获取自驾订单轨迹数据
#define Person_GetSelfDrivesearchTrack_URL @"appGateway/self_driver/position/searchTrack"
...
//个人平台-新版消息分类 【New】
#define PERSON_NewMessage_Category_URL @"zkmlperson/mobileTerminal/getUserRecentMessagesCategoriesV3"


//个人平台-新版消息分类具体(二级消息界面接口) 【New】
#define PERSON_NewMessage_CategorySpecific_URL @"zkmlperson/mobileTerminal/getUserRecentMessagesByCategoryV2"
...
//运营平台版本更新
//删除版本更新
#define PERSON_DeleteAppVersionMsgByAppMsgId_URL @"zkmlperson/mobileTerminal/deleteAppVersionMsgByAppMsgId"
//获取版本更新列表
#define PERSON_FindSimpleAppVersionMsgList_URL @"zkmlperson/mobileTerminal/findSimpleAppVersionMsgList"
//获取版本更新内容
#define PERSON_FindAppVersionMsgDetailByAppMsgId_URL @"zkmlperson/mobileTerminal/findAppVersionMsgDetailByAppMsgId"
...
#define PERSON_HelpCenterList_URL @"zkmlperson/mobileTerminal/queryHelpsV2"
//帮助中心详情
...
//刷脸登录
#define PERSON_FaceLogin_URL @"zkmlperson/mobileTerminal/faceLogin"
//开启刷脸登录
#define PERSON_Open_FaceLogin_URL @"zkmlperson/mobileTerminal/doOpenFaceDetect"
//获取信息安全设置
#define PERSON_Get_SafeSetting_URL @"zkmlperson/mobileTerminal/getSafeSetting"
//保存信息安全设置
#define PERSON_Set_SafeSetting_URL @"zkmlperson/mobileTerminal/doCloseFaceDetect"
...
//添加航班号的历史记录
#define PERSON_AddFlightInfo_URL @"zkmlperson/mobileTerminal/addUserFlightRecordInfo"
//删除航班号的历史记录
#define PERSON_DeleteFlightInfo_URL @"zkmlperson/mobileTerminal/deleteUserFlightRecordInfo"
//获取航班号的历史记录
#define PERSON_GetFlightHistoryList_URL @"zkmlperson/mobileTerminal/getUserFlightRecordInfo"
...
//获取客服中心问题
#define PERSON_GetCustomerCenterData_URL @"zkmlperson/mobileTerminal/queryClassifyHelps"
//获取驾驶员信息
#define PERSON_MobileTerminalGetDriverInfo_URL @"zkmlperson/mobileTerminal/getDriverInfo"
//更新驾驶员驾驶员信息
#define PERSON_MobileTerminaluUpdateDriverInfo_URL @"zkmlperson/mobileTerminal/updateDriverInfo"
//获取个人统一身份认证信息【废弃】
#define PERSON_Get_PersonUserInfo_URL @"zkmlperson/mobileTerminal/getPersonalUserInfo"

//查询个人认证信息
//#define PERSON_Get_PersonAuthInfo_URL @"zkmlperson/mobileTerminal/getPersonalAuthInfo"
#define PERSON_Get_PersonAuthInfo_URL @"zkmlperson/mobileTerminal/getPersonalAuthInfoV2"
//进行身份证认证
#define PERSON_Post_Confirm_PersonIdentity_URL @"zkmlperson/mobileTerminal/identityCardAuth"
//进行驾驶证认证
#define PERSON_Post_Confirm_DriverIdentity_URL @"zkmlperson/mobileTerminal/driverCardAuth"
//申诉条款字典
#define PERSON_GET_Appeal_ModifyKeyList_URL @"zkmlperson/mobileTerminal/getIdentityAppealModifyKeyList"
//保存申诉信息
#define PERSON_Post_Appeal_SaveIdentity_URL @"zkmlperson/mobileTerminal/saveIdentityAppeal"
//确认申诉结果
#define PERSON_Post_Appeal_updateIdentityAppealResult_URL @"zkmlperson/mobileTerminal/updateIdentityAppealResult"


//提交匿名投诉
#define PERSON_Post_Confirm_DriverComplain_URL @"zkmlperson/mobileTerminal/doAddComplaintAccusation"
//投诉中心列表
#define PERSON_Get_DriverComplain_List_URL @"zkmlperson/mobileTerminal/getApplyComplaintList"
//获取投诉详情
#define PERSON_Get_DriverComplain_Detail_URL @"zkmlperson/mobileTerminal/getApplyComplaintDetail"
//获取所有投诉问题标签集合
#define PERSON_Get_DriverComplain_TagList_URL @"zkmlperson/mobileTerminal/getApplyComplaintSysTagList"

//获取个人常用备注
#define PERSON_Get_OwnCommonNoteList_URL @"zkmlperson/mobileTerminal/getOwnCommonNoteList"
//添加个人常用备注
#define PERSON_Post_DoAddOwnCommonNote_URL @"zkmlperson/mobileTerminal/doAddOwnCommonNote"
//删除个人常用备注
#define PERSON_Post_DeleteOwnCommonNoteById_URL @"zkmlperson/mobileTerminal/deleteOwnCommonNoteById"
//编辑常用备注
#define PERSON_Post_DoUpdatedOwnCommonNote_URL @"zkmlperson/mobileTerminal/doUpdatedOwnCommonNote"

//扫码绑定用户
#define PERSON_Post_BingUserByQr_URL @"zkmlperson/mobileTerminal/doBingUserByQr"
//扫码取消登录
#define PERSON_Post_CancelLoginByQr_URL @"zkmlperson/mobileTerminal/doCancelLoginByQr"
//扫码确认登录
#define PERSON_Post_ConfirmLoginByQr_URL @"zkmlperson/mobileTerminal/doConfirmLoginByQr"
