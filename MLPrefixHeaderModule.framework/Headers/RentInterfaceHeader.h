...
#ifndef RentInterfaceHeader_h
#define RentInterfaceHeader_h

//租赁平台获取拒单设置【New】
#define RENT_Get_RejectOrder_URL   @"zkmlrent/mobileDriverV2/obtDriverRejctOrderSetting"
//租赁平台更新拒单设置【New】
#define RENT_Update_RejectOrder_URL   @"zkmlrent/mobileDriverV2/updateDriverRejectOrderSetting"
...
//租赁平台根据订单号查审核id-审核操作【New】
#define RENT_MobileOrderV2GetOrderIdByOrderSn   @"zkmlrent/mobileApplyV2/getApplyIdByApplySn"
//租赁平台根据订单号查询公车出行单详情
#define RENT_MobileOrderV2ObtApplyInfoByApplySn   @"zkmlrent/mobileApplyV2/obtApplyInfoByApplySn"
//租赁平台消息跳转指引接口
#define RENT_MobileOrderV2ObtOrderForward @"zkmlrent/mobileOrderV2/orderForward"
//租赁平台消息网约车跳转指引接口
#define RENT_MobileOnlineCarV2ObtOrderStatusByOrderId @"zkmlrent/mobileOrderV2/obtOrderStatusByOrderId"
...
//租赁调度审核-获取订单列表【New】
#define RENT_Get_Lease_DispatchCheckOrder_List_URL           @"zkmlrent/mobileOrderV2/pageOrder4DispatchCheck"
//租赁调度审核-提交、退回审核【New】
#define RENT_SubmitAndReturn_Lease_DispatchCheckOrder_List_URL           @"zkmlrent/mobileOrderV2/checkOrder"
//租赁调度审核-获取服务网点【New】
#define RENT_Get_Lease_DispatchCheckOrder_ServicePosition_List_URL           @"zkmlrent/mobileOrderV2/findBranchList"
...
//服务中心调度派车-根据服务网点获取车辆
#define RENT_Get_Lease_DispatchCarGetAllCar_URL           @"zkmlrent/mobileOrderV2/findBranchCarTypeAndCarList"
//服务中心调度派车-根据服务网点获取司机
#define RENT_Get_Lease_DispatchCarGetAllDriver_URL @"zkmlrent/mobileOrderV2/findBranchDriverList"
...
//根据车牌号选车接口
#define  RENT_ChangeBranch4AppDispatchOnCarNo_URL   @"zkmlrent/mobileOrderV2/changeBranch4AppDispatchOnCarNo"//xgw+
...
//租赁交车审核-交车补单【New】
#define RENT_Confirm_Lease_BudanCheck_URL           @"zkmlrent/mobileOrderV2/doMend"
...
//交车审核-获取补单任务里程【New】
#define RENT_GET_JiaoCheMile_URL    @"zkmlrent/mobileOrderV2/ajaxMileCalculate"
...
#define RENT_Get_DriverTaskInfo_URL    @"zkmlrent/mobileOrderV2/findDriverTaskInfo"

//司机任务-消息跳转时获取任务详情【NEW】
#define RENT_Get_DriverTask_Detail_FromMessage_URL           @"zkmlrent/mobileOrderV2/getDriverOrderTaskDetail"
//司机任务-消息跳转时获取正在执行任务或驾驶员更紧急任务【NEW】
#define RENT_Get_Driver_DoingOrEmergencyTask_FromMessage_URL           @"zkmlrent/mobileOrderV2/getDriverUrgencyTask"

//司机任务-城际出行移除订单
#define RENT_InterCity_Driver_DelUnionOrderCar_URL        @"zkmlrent/mobileOrderV2/doDeleteUnionOrderCar"
//司机任务-城际出行同一路线订单
#define RENT_InterCity_Driver_GetSameLineOrderCar_URL  @"zkmlrent/mobileOrderV2/getSameLineOrderCar"
//司机任务-城际出行添加订单
#define RENT_InterCity_Driver_AddUnionOrderCar_URL  @"zkmlrent/mobileOrderV2/doAddUnionOrderCar"
//司机任务-城际出行判断是否是城际订单
#define RENT_InterCity_Driver_GetUnionIntercityOrderCar_URL @"zkmlrent/mobileOrderV2/getUnionIntercityOrderCarList"
...
//获取调度审核操作记录
#define RENT_Get_DiaoDu_ReqOrderLog_URL   @"zkmlrent/mobileOrderV2/reqOrderLog"
//车辆状态-获取车辆状态数量【New】
...
//司机状态-获取司机状态列表部门接口【New】(最新接口)
#define RENT_Get_ObtDriverStatusListByOrganIdAndStatusOrderByDriverName_ListMessage_URL   @"zkmlrent/mobileDriverV2/obtDriverStatusListByOrganIdAndStatusOrderByDriverName"
//司机状态-获取司机状态详情接口【New】
...
//请求一键用车获取车辆数据【New】 //findProfessionCar
#define SERVICECENTER_GET_OneKey_UseCar_URL @"zkmlrent/mobileApplyV2/findOneKeyCarList"
//请求一键用车根据车辆获取驾驶员数据【New】findProfessionDriver
#define SERVICECENTER_GET_OneKey_UseDriver_ByCar_URL @"zkmlrent/mobileApplyV2/findOneKeyCarBusinessList"
//请求一键用车根据车辆获取地址用车事由【New】findProfessionDriver
#define SERVICECENTER_GET_OneKey_UseCarReason_ByCar_URL @"zkmlrent/mobileApplyV2/findOneKeyCarAddressAndReasonList"
...
#define RENT_GET_Attendance_UserMonthAttendanceList @"zkmlrent/mobileAttendanceV2/findUserMonthAttendanceList" //查询考勤纪录
#define RENT_GET_Attendance_UserMonthAttendanceClockRecord @"zkmlrent/mobileAttendanceV2/findUserMonthAttendanceClockRecord" //考勤月报
...
#define RENT_Commit_Customer_Unit_URL        @"zkmlrent/mobileApplyV2/addCustomer"//新增客户单位
...
//调拨管理
//租赁调拨-获取合作单位集合【New】
#define RENT_Allocate_Lease_CooperateCompany_URL           @"zkmlrent/mobileAllocationV2/findAllocatedOrganList"
//租赁调拨-获取合作单位是否被调拨过信息【New】
#define RENT_Allocate_CooperateCompany_QueryRepeat_URL           @"zkmlrent/mobileAllocationV2/queryRepeat"
//租赁调拨-获取合作单位下车型集合【New】
#define RENT_Allocate_CooperateCompany_CarTypeList_URL           @"zkmlrent/mobileAllocationV2/findCarTypeByOrganIdAndDeploySign"
//租赁调拨-提交调拨【New】
#define RENT_Allocate_DoAdd_URL             @"zkmlrent/mobileAllocationV2/doAdd"
//租赁调拨-修改调拨【New】
#define RENT_Allocate_DoUpdate_URL            @"zkmlrent/mobileAllocationV2/doUpdate"
//租赁调度派车-获取调拨合作单位集合【New】
#define RENT_Allocate_DispatchCheck_ServicePoint_URL           @"zkmlrent/mobileOrderV2/findAllocationOrganList"
//调拨合并按车牌按车型派车后根据合作单位获取车、司机
#define RENT_Allocate_DispatchCarGetAllCarAndDriver_URL           @"zkmlrent/mobileOrderV2/findAllocateCarAndDriverList"
//租赁调拨派车-根据车牌号获取费用标准【New】
#define RENT_Allocate_DispatchChangeCarNo_URL           @"zkmlrent/mobileOrderV2/findBillingList"
//租赁调度-服务中心取消调拨【New】
#define RENT_Allocate_CancelOrder_URL           @"zkmlrent/mobileAllocationV2/doCancelAllocationOrder"
//租赁调度-租赁公司取消调拨【New】
#define RENT_Allocate_CancelOrder_Split_URL           @"zkmlrent/mobileAllocationV2/doApplyCancelAllocation"

//调拨任务-司机调拨任务
//调拨司机任务列表
#define Allocate_Driver_TaskList_GetURL @"appGateway/allot/driver/task/findDriverTaskList"
//调拨确认任务
#define Allocate_Driver_ConfirmTask_GetURL @"appGateway/allot/driver/task/doConfirmTask"
//调拨开始任务
#define Allocate_Driver_StartTask_GetURL @"appGateway/allot/driver/task/doStartTask"
//调拨结束任务
#define Allocate_Driver_EndTask_GetURL @"appGateway/allot/driver/task/doEndTask"
//调拨订单详情
#define Allocate_Driver_OrderDetail_GetURL @"appGateway/allot/driver/task/taskDetail"
//调拨订单轨迹
#define Allocate_Driver_OrderTaskTrace_GetURL @"appGateway/allot/driver/task/taskTrack"
...
#define RENT_GET_CalculateMiles_URL @"zkmlrent/mobileOrderV2/ajaxMileCalculate" //获取派车补录计算任务里程
...
#define RENT_Check_RecordOrderTime_URL @"zkmlrent/mobileOrderV2/judgeFillOrderTimeLine" //判断派车单是否有冲突
...
/**终端报警列表New*/
#define RENT_MobileWarnV2FindTerminalWarnList_URL @"zkmlrent/mobileWarnV2/findTerminalWarnList"

/**终端报警处理New*/
#define RENT_MobileWarnV2DoHandleTerminalWarn_URL @"zkmlrent/mobileWarnV2/doHandleTerminalWarn"

/**终端报警查询外协单位New*/
#define RENT_MobileWarnV2SelectOutsourcingUnitByAreaId_URL @"zkmlrent/mobileWarnV2/selectOutsourcingUnitByAreaId"

//过期任务查询接口
#define RENT_WarningInfoApp_OverDueTaskList_URL @"zkmlrent/mobileWarnV2/overdueTask"

/**超速报警列表*/
#define RENT_MobileWarnV2ObtOverSpeedWarnList_URL @"zkmlrent/mobileWarnV2/obtOverSpeedWarnList"

/**定点停放列表*/
#define RENT_MobileWarnV2FixedPointParkWarning_URL @"zkmlrent/mobileCarFixedPointWarningV2/fixedPointParkWarning"

/**定点停放轨迹*/
#define RENT_MobileWarnV2GetPointParkWarningTrackByCarNo_URL @"zkmlrent/mobileCarFixedPointWarningV2/getPointParkWarningTrackByCarNo"


/**获取下拉选数据*/
#define RENT_QueryConditionV2QueryConditionList4App_URL @"zkmlrent/queryConditionV2/queryConditionList4App"

/**定点停放列表*/
#define RENT_MobileWarnV2DoPointParkWarningAppeal_URL @"zkmlrent/mobileCarFixedPointWarningV2/doPointParkWarningAppeal"
...
/******************司机报销关联任务单*****************/
#define RENT_DriverReimbursementConfList_URL @"zkmlrent/mobileDriverV2/obtReimburseConfAndMissMealConf" //获取当前单位设置的报销设置和误餐费设置

#define RENT_FindReimburseOrderCarList_URL @"zkmlrent/mobileDriverV2/findReimburseOrderCar" //获取指定时间内驾驶员所有可以用于报销的任务单

#define RENT_CommitAddReimburseApply_URL @"zkmlrent/mobileDriverV2/doAddReimburseApply" //新增报销记录

/******************司机报销*****************/
/**查询司机报销列表*/
#define RENT_MobileOrderV2GetPersonalReimburseApply_URL @"zkmlrent/mobileDriverV2/getPersonalReimburseApply"
/**查询审核审批列表*/
#define RENT_MobileOrderV2FindReimbursementApplyCheckList_URL @"zkmlrent/mobileDriverV2/findReimbursementApplyCheckList"
/**查询审核审批列表*/
#define RENT_MobileOrderV2DoReimbursementCheck_URL @"zkmlrent/mobileDriverV2/doReimbursementCheck"

/**查询审核审批详情*/
#define RENT_MobileOrderV2FindReimbursementDetail_URL @"zkmlrent/mobileDriverV2/findReimbursementDetail"

/**查询审核审批详情*/
#define RENT_MobileOrderV2FindReimburseOrderCarDetail_URL @"zkmlrent/mobileDriverV2/findReimburseOrderCarDetail"



/**查询司机报销操作记录*/
#define RENT_MobileOrderV2FindApplyLogList_URL @"zkmlrent/mobileDriverV2/findApplyLogList"
/**查询司机报销记录*/
#define RENT_DoAddReimburseApply_URL @"zkmlrent/mobileDriverV2/doAddReimburseApply"
#define RENT_DoModifyReimbursementApply_URL @"zkmlrent/mobileDriverV2/doModifyReimbursementApply"

/**查询司机报销记录编辑接口*/
#define RENT_ToModifyReimbursementApply_URL @"zkmlrent/mobileDriverV2/toModifyReimbursementApply"

/**司机报销取消*/
#define RENT_MobileOrderV2FDoCancelReimbursementApply_URL @"zkmlrent/mobileDriverV2/doCancelReimbursementApply"
/**司机报销作废*/
#define RENT_MobileOrderV2DoWasteReimbursementApply_URL @"zkmlrent/mobileDriverV2/doWasteReimbursementApply"

/*********用车统计**********/
/*****用车车型统计界面***/
#define RENT_MobileOrderV2ObtDispatcherCarStatsListByCarType_URL @"zkmlrent/mobileStatsAnalysisV2/obtDispatcherCarStatsListByCarType"
/*****出车统计界面***/
#define RENT_MobileOrderV2ObtOrganCarUseRateBetweenTime_URL @"zkmlrent/mobileStatsAnalysisV2/obtOrganCarUseRateBetweenTime"
/*****已出任务车辆列表***/
#define RENT_MobileOrderV2ObtDispatcherCarStatsList_URL @"zkmlrent/mobileStatsAnalysisV2/obtDispatcherCarStatsList"
/*****用车率折线图***/
#define RENT_MobileOrderV2ObtOrganCarUseRateInTimeRange_URL @"zkmlrent/mobileStatsAnalysisV2/obtOrganCarUseRateInTimeRange"
/*****单车使用率接口***/
#define RENT_MobileOrderV2ObtCarUseRateStatsList_URL @"zkmlrent/mobileStatsAnalysisV2/obtCarUseRateStatsList"

/*****用车率折线图***/
#define RENT_MemberStatsAnalysisV2ObtOrganCarUseRateInTimeRange_URL @"zkmlrent/mobileStatsAnalysisV2/obtOrganCarUseRateInTimeRange"

/*********车辆轨迹**********/
#define RENT_GET_NewPositionList_URL @"zkmlrent/realTimeRefreshV2/newPositionList" //车辆轨迹首页接口
#define RENT_GET_PositionTimer_URL @"zkmlrent/realTimeRefreshV2/positionTimer"//车辆具体定位及各状态车辆数量接口
#define RENT_GET_ObtainTrackV2_URL @"zkmlrent/realTimeRefreshV2/obtainTrackV2ForApp"//车辆轨迹首页接口
#define RENT_GET_calculateTrackMiles_URL @"zkmlrent/realTimeRefreshV2/calculateTrackMiles"//车辆轨迹首页接口


/*********服务中心留言板**********/
//获取留言列表数据【New】
#define RENT_Find_LeaveMessage_List_URL @"zkmlrent/mobileOrderV2/findOrderLeaveMessageByOrderSn"
//删除单个留言数据【New】
#define RENT_Delete_LeaveMessage_URL           @"zkmlrent/mobileOrderV2/doDeleteOrderLeaveMessage"
//添加留言数据【New】
#define RENT_Add_LeaveMessage_URL           @"zkmlrent/mobileOrderV2/doAddOrderLeaveMessage"



#endif /* RentInterfaceHeader_h */
